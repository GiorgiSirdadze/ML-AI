...
def check_copies_helper(person, one_gene, two_genes):
...
def probs_has_parents(person, people, one_gene, two_genes, have_trait):
    ...
    mother_genes = check_copies_helper(mother, one_gene, two_genes)

    father = people[person]["father"]
    father_genes = check_copies_helper(father, one_gene, two_genes)
    ...
    child_genes = check_copies_helper(person, one_gene, two_genes)  # Corrected function call
# If child_genes = 0, we have 4 scenarios
    if child_genes == 0:
...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        copies_gene = check_copies_helper(person, one_gene, two_genes)
